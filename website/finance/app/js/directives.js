...
var financeDirectives = angular.module('financeDirectives', []);

financeDirectives.directive('appVersion', ['version', function(version) {
    return function(scope, elm, attrs) {
        elm.text(version);
    };
}]);

financeDirectives.directive('focus', function() {
    return function(scope, element) {
        element[0].focus();
    };
});

financeDirectives.directive('trxTransferAccountName', function() {
    return function($scope, element) {
...
financeDirectives.directive('trxDebitAmount', ['$filter', function($filter) {
    return function($scope, element) {
        if ($scope.account.account_id == $scope.trx.debit.account_id) {
...
financeDirectives.directive('trxCreditAmount', ['$filter', function($filter) {
    return function($scope, element) {
...
financeDirectives.directive('modal', ['$parse', function($parse) {
    var backdropEl;
